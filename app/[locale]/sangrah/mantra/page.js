...
export default async function MantraListingPage({ params }) {
    const { locale } = await params;
    ...
    const breadcrumbData = {
        ...
        'itemListElement': [
            ...
            },
            {
                '@type': 'ListItem',
                'position': 3,
                'name': locale === 'hi' ? 'मंत्र' : 'Mantra',
                'item': locale === 'hi' ? 'https://www.sanatan-sangam.com/hi/sangrah/mantra' : 'https://www.sanatan-sangam.com/sangrah/mantra',
            },
        ],
    };
