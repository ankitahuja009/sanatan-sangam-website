...
const values = [
    ...
    { icon: '💡', title: 'Innovation', desc: 'Blending the wisdom of tradition with the power of modern AI technology.' },
];

const features = [
    { icon: '✨', title: 'Divya Chhavi', desc: 'AI-powered divine portraits with 30+ deities & gurus' },
    { icon: '🎶', title: 'Tunemate', desc: 'Compose personalized devotional bhajans with AI' },
            ...
            <section className={`section ${styles.mission}`}>
                <div className="container">
                    ...
                    <div className={styles.missionContent}>
                        ...
                        <p>
                            From live temple darshan to AI-powered spiritual art, from devotional music to
